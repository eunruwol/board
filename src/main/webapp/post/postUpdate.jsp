			...
			<div class="secondTitle">
				...
				<table cellspacing="0" cellpadding="0" class="insertTable">
					...
					<tr>
						...
						<td>
							<input type="text" name="post_tit" class="insertInputs" value="${postVo.post_tit}" />
						</td>
					</tr>
				</table>
				...
				<table cellspacing="0" cellpadding="0" class="insertTable">
					...
					<tr>
						...
						<td>
							<textarea name="post_con" id="smarteditor" rows="30" cols="100">
								${postVo.post_con}
							</textarea>
						</td>
					</tr>
				...
				<table cellspacing="0" cellpadding="0" class="insertTables">
					...
					<tr>
						<td class="insertTableTitles">첨부된 파일</td>
						<td>
							<ul class="postFileLists">
								<c:forEach items="${fileList}" var="file">
									<li data-id="${file.file_no}">${file.file_name}</li>
								</c:forEach>
							</ul>
						</td>
					</tr>
				...
				<script type="text/javascript">
					$(function(){
						var listSize = $(".insertTables").length; // 첨부파일 파일추가 버튼 사이즈(개수)
						var listSizeBefore = $(".postFileLists li").length; // 이미 추가되어있는 첨부파일 개수
						var possibleSize = 5 - listSizeBefore; // 추가적으로 등록할 수 있는 첨부파일 개수
						var fileName = 2;
				...
				<div class="listAndSubmitButton">
					...
					<button type="submit" class="listGoSubmitButton">수정</button>
				</div>
			</div>
		</form>
	</div>
